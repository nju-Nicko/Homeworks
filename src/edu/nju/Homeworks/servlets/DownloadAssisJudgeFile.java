...
/**
 * Servlet implementation class DownloadAssisJudgeFile
 */
@WebServlet("/DownloadAssisJudgeFile")
public class DownloadAssisJudgeFile extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public DownloadAssisJudgeFile() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String path=hd.downloadAssisJudgeFile(cou_name, stu_name, h_id);
