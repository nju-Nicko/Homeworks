...
public class GetStudentsHandler extends SimpleTagSupport {
	
	public void doTag(){
		UserDao ud=new UserDaoImpl();
		ArrayList<UserBean> list=ud.loadAllStudents();
		String result="";
		...
		try {
			out.println("<input id=\"a_stu\" type=\"text\" value=\""+result+"\" style=\"display: none;\"/>");
		} catch (IOException e) {
