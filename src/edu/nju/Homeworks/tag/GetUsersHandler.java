...
public class GetUsersHandler extends SimpleTagSupport{
	
	public void doTag(){
		UserDao ud=new UserDaoImpl();
		ArrayList<UserBean> list=ud.loadAll();
		String result="";
		...
		try {
			out.println("<input id=\"a_u\" type=\"text\" value=\""+result+"\" style=\"display: none;\"/>");
		} catch (IOException e) {
